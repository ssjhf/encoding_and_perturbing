...
plt.plot(wors_epsilon, wors_avg_variance, color='g', marker='o', markerfacecolor='none', linewidth=1, markersize=14, linestyle='-', label='SWOR Theoretical')
plt.plot(work_epsilon, work_avg_variance, color='r', marker='s', markerfacecolor='none', linewidth=1, markersize=14, linestyle='-', label='KWOR Theoretical')
...
plt.plot(wors_epsilon_num, wors_avg_variance_num, color='g', marker='o', markerfacecolor='none', linewidth=1, markersize=14, linestyle='--', label='SWOR Numerical')
plt.plot(work_epsilon_num, work_avg_variance_num, color='r', marker='s', markerfacecolor='none', linewidth=1, markersize=14, linestyle='--', label='KWOR Numerical')
...
plt.grid(True)
plt.legend()
plt.savefig('Comparison of mechanisms for kosarak dataset.pdf', format='pdf')
plt.show()
